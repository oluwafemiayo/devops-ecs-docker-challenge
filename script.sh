...
docker tag app:latest 135155369967.dkr.ecr.eu-west-3.amazonaws.com/my_first_ecr_repo:latest
...
docker push 135155369967.dkr.ecr.eu-west-3.amazonaws.com/my_first_ecr_repo:latest
